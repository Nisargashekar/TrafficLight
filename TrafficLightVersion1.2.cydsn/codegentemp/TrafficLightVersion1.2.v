// ======================================================================
// TrafficLightVersion1.2.v generated from TopDesign.cysch
// 06/07/2019 at 15:00
...
module ADC_DelSig_v3_30_2 (
	...
	cy_clock_v1_0
		#(.id("1e947532-5ccc-441e-a3df-b91e951ab4a7/b7604721-db56-4477-98c2-8fae77869066"),
	...
	cy_clock_v1_0
		#(.id("1e947532-5ccc-441e-a3df-b91e951ab4a7/edd15f43-b66b-457b-be3a-5342345270c8"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
		  .period("7812500000"),
		  .is_direct(0),
...
module top ;
	...
	wire [0:0] tmpOE__AfterHours_net;
	wire [0:0] tmpIO_0__AfterHours_net;
	wire [0:0] tmpINTERRUPT_0__AfterHours_net;
	electrical [0:0] tmpSIOVREF__AfterHours_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		AfterHours
		 (.oe(tmpOE__AfterHours_net),
		  .y({1'b0}),
		  .fb({Net_5}),
		  .io({tmpIO_0__AfterHours_net[0:0]}),
		  .siovref(tmpSIOVREF__AfterHours_net),
		  .interrupt({tmpINTERRUPT_0__AfterHours_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__AfterHours_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_clock_v1_0
		#(.id("6f746558-05d8-49ac-8888-e97fabeb6fd6"),
	...
	wire [0:0] tmpOE__Setting_mode_net;
	wire [0:0] tmpIO_0__Setting_mode_net;
	wire [0:0] tmpINTERRUPT_0__Setting_mode_net;
	electrical [0:0] tmpSIOVREF__Setting_mode_net;

	cy_psoc3_pins_v1_10
		#(.id("d2d207fc-3d3a-40fb-b9fd-26c81656a2f6"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Setting_mode
		 (.oe(tmpOE__Setting_mode_net),
		  .y({1'b0}),
		  .fb({Net_141}),
		  .io({tmpIO_0__Setting_mode_net[0:0]}),
		  .siovref(tmpSIOVREF__Setting_mode_net),
		  .interrupt({tmpINTERRUPT_0__Setting_mode_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Setting_mode_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_clock_v1_0
		#(.id("08147f16-fa87-462a-9049-13888029f5e3"),
		  .source_clock_id("CEF43CFB-0213-49b9-B980-2FFAB81C5B47"),
		  .divisor(0),
		  .period("10000000000000"),
		  .is_direct(0),
