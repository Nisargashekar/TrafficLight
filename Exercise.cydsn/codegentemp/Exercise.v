// ======================================================================
// Exercise.v generated from TopDesign.cysch
// 04/07/2019 at 21:15
...
module top ;
	...
	wire [0:0] tmpOE__Switch2_net;
	wire [0:0] tmpFB_0__Switch2_net;
	wire [0:0] tmpIO_0__Switch2_net;
	wire [0:0] tmpINTERRUPT_0__Switch2_net;
	electrical [0:0] tmpSIOVREF__Switch2_net;

	cy_psoc3_pins_v1_10
		#(.id("0f89ca0b-4c83-4d0c-aee6-727b52fd7610"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		Switch2
		 (.oe(tmpOE__Switch2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Switch2_net[0:0]}),
		  .io({tmpIO_0__Switch2_net[0:0]}),
		  .siovref(tmpSIOVREF__Switch2_net),
		  .interrupt({tmpINTERRUPT_0__Switch2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Switch2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("2537fc6e-4885-479b-a978-05c46e31c256"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
